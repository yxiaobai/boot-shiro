...
import com.spbs.bootshiro.common.utils.AddressUtils;
...
public class LogServiceImpl extends BaseService<TLog> implements LogService {
    ...
    @Override
    public List<TLog> findAllLogs(TLog log) {
        try {
    ...
    public void deleteLogs(String logIds) {
        ...
        this.batchDelete(list, "id", TLog.class);
    }

    @Override
    public void saveLog(ProceedingJoinPoint joinPoint, TLog log) throws JsonProcessingException {
